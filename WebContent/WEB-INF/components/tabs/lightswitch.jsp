...
<br></br>
<p align="center">
<a href="LightServlet.do?light=on"><img border="0" alt="Yes" src="image/yes-button.png" /></a>
<a href="LightServlet.do?light=off"><img border="0" alt="No" src="image/no-button.png" /></a>
<!--<% if (lightOn) { %>-->
